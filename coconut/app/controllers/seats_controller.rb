class SeatsController < ApplicationController
  ...
  def update
    ...
    respond_to do |format|
      if @seat.update(seat_params)
        format.html { redirect_to flight_url(flight_id), notice: "Seat was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to flight_path(flight_id), notice: "Seat was successfully destroyed." }
  ...
  private
    ...
    def seat_params
      params.require(:seat).permit(:id, :flight_id, :name, :baggage)
    end
end
