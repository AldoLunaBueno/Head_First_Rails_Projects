...
class SeatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seat" do
    assert_difference("Seat.count") do
      post seats_url, params: { seat: { baggage: @seat.baggage, flight_id: @seat.flight_id, id: @seat.id, name: @seat.name } }
    end
  ...
  test "should update seat" do
    patch seat_url(@seat), params: { seat: { baggage: @seat.baggage, flight_id: @seat.flight_id, id: @seat.id, name: @seat.name } }
